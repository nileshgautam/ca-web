	...
	<div class="row">
		<div class="col-sm-12">
			...
			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-business-registrations
" role="tab" aria-controls="pills-home" aria-selected="true">Business Registrations
					</a>
				</li>
	...
	<div class="row" id="testimonial">
		<div class="col-sm-3">
			<div class="card">
				...
				<div class="card-body">
					<h6 class="card-title text-primary">Rahul Shrivastava</h6>
		...
		<div class="col-sm-3">
			<div class="card">
				<img class="card-img-top" src="<?php echo base_url('assets/image/user.png') ?>" alt="Card image cap">
				<div class="card-body">
					<h6 class="card-title text-primary">Piyush Mehra</h6>
					<p class="">CEO, Ecommerce Mart</p>
		...
		<div class="col-sm-3">
			<div class="card">
				<img class="card-img-top" src="<?php echo base_url('assets/image/user.png') ?>" alt="Card image cap">
				<div class="card-body">
					<h6 class="card-title text-primary">Ritika Sharma</h6>
					<p class="">CEO, Ecommerce Mart</p>
		...
		<div class="col-sm-3">
			<div class="card">
				<img class="card-img-top" src="<?php echo base_url('assets/image/user.png') ?>" alt="Card image cap">
				<div class="card-body">
					<h6 class="card-title text-primary">Neha Bhatnagar</h6>
					<p class="">CEO, Ecommerce Mart</p>
