                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-12 border-right pr-0 border-dark">
                                        <div class="card-body inner-center">
                                            <div class="ticket-customer font-weight-bold"><?php echo $_SESSION['userInfo']['name'];?></div>
                                            <div class="ticket-type-icon private mt-1 mb-1"><i class="feather ti-lock mr-1 f-14"></i><?php echo 'Subject:'.$tickets[$i]['subject'];?></div>
                                            <div><i class="ti-time"></i><?php echo " ". $tickets[$i]['date_time'];?> [status]</div>
